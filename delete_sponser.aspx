<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_sponser.aspx.cs" Inherits="delete_sponser" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="delete_Sponser.css" />
    <title>DELETE SPONSER</title>
</head>
<body>
    <form id="form1" runat="server">
       <div>
            <header>DELETE SPONSER</header>
        </div>

        <div class="reg">
            
            <asp:TextBox ID="TextBox1" name=" " placeholder=" " class="reg__form"  runat="server" Width="689px" Height="37px"></asp:TextBox>
            <label for="TextBox1" class="reg__form1">Enter Company Name you want to delete</label>
