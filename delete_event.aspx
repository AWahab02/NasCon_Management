<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_event.aspx.cs" Inherits="delete_event" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="delete_event.css"  />
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="reg">
            ...
            <label for="TextBox1" class="reg__form1">Enter Event Name which you want to delete</label>
