<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_team.aspx.cs" Inherits="add_team" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="reg">
            ...
            <label for="TextBox2" class="reg__form2">Insititute Name</label>
            ...
            <label for="TextBox3" class="reg__form3">Head Name</label>
            ...
            <label for="TextBox4" class="reg__form4">Head Email</label>
            ...
            <label for="TextBox5" class="reg__form5">Head CNIC</label>
            ...
            <label for="TextBox6" class="reg__form6">Head Contact No</label>
            ...
            <label for="TextBox7" class="reg__form7">No of Members</label>
            ...
            <label for="TextBox8" class="reg__form8">Event Name</label>
            ...
            <label for="TextBox9" class="reg__form9">Category Name</label>
            ...
            <asp:Button ID="Btn" class="Hash" Text="Add Team" runat="server" CssClass="Hash" OnClick="Btn_Click" /> 
            <!-- Bubbles animation -->
