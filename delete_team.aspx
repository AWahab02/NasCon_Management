<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_team.aspx.cs" Inherits="delete_team" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="reg">
            ...
            <label for="TextBox1" class="reg__form1">Enter Team Name you want to delete</label>
