<%@ Page Language="C#" AutoEventWireup="true" CodeFile="modify_sponser.aspx.cs" Inherits="modify_sponser" %>
...
<head runat="server">
    ...
    <title>MODIFY SPONSER</title>
</head>
<body>
    <form id="form1" runat="server">
       <div>
            <header>MODIFY SPONSER</header>
        </div>

        <div class="reg">
            
            <asp:TextBox ID="TextBox1" name=" " placeholder=" " class="reg__form"  runat="server" Width="689px" Height="37px"></asp:TextBox>
            <label for="TextBox1" class="reg__form1">Enter Company Name you want to update</label>
            ...
            <asp:TextBox ID="TextBox2" class="reg__TLCNIC" name=" " placeholder=" "  runat="server" Width="689px" Height="37px"></asp:TextBox>
            <label for="TextBox2" class="reg__form2">Enter New Package</label>
