<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_mentor.aspx.cs" Inherits="delete_mentor" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <header>DELETE MENTOR</header>
        </div>

        <div class="reg">
            
            <asp:TextBox ID="TextBox1" name=" " placeholder=" " class="reg__form"  runat="server" Width="689px" Height="37px"></asp:TextBox>
            <label for="TextBox1" class="reg__form1">Enter Employee ID you want to delete</label>
