<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_sponser.aspx.cs" Inherits="add_sponser" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="add_Sponser.css" />
    <title>ADD SPONSER</title>
</head>
<body>
    <form id="form1" runat="server">
       <div>
            <header>ADD SPONSER</header>
        </div>

        <div class="reg">
            
            <asp:TextBox ID="TextBox1" name=" " placeholder=" " class="reg__form"  runat="server" Width="689px" Height="37px"></asp:TextBox>
            <label for="TextBox1" class="reg__form1">Company Name</label>
            ...
            <label for="TextBox2" class="reg__form2">Representive Name</label>
            ...
            <label for="TextBox3" class="reg__form3">Representive CNIC</label>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" Display="Dynamic" ErrorMessage="Name is mandatory" ForeColor="Red" SetFocusOnError="True" InitialValue=" " ClientIDMode="AutoID" Font-Size="XX-Large">*</asp:RequiredFieldValidator>
              <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="TextBox3" runat="server" ForeColor="Red" ValidationExpression="^[0-9]{5}-[0-9]{7}-[0-9]" Font-Size="XX-Large">( - )</asp:RegularExpressionValidator>
            ...
            <label for="TextBox4" class="reg__form4">Package</label>
            ...
            <asp:Button ID="Btn" class="Hash" Text="Add Sponser" runat="server" CssClass="Hash" OnClick="Btn_Click" /> 
            <!-- Bubbles animation -->
